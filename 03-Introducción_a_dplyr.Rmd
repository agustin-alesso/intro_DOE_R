...
En este capítulo y el siguiente se introducirán dos paquetes de **R** que están siendo ampliamente utilizados por la comunidad: `dplyr` y `ggplot2`. 
...
Para ilustrar el uso del paquete vamos a usar los datos contenidos en el archivo [`pesada_terneros.xlsx`](https://github.com/Estadistica-FCA/tutoriales_R/raw/master/data/pesada_terneros.xlsx). 
